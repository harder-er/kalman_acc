...
HD_PWD='D:/Main_Files/postgraduate/direction/kalman_rtl/kalman_acc_sv/kalman_acc_sv.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KalmanFilterTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source KalmanFilterTop.tcl
