...
HD_PWD='D:/zgh/direction/kalman_rtl/kalman_acc_sv/kalman_acc_sv.runs/floating_point_sub_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_sub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_sub.tcl
