...
module CEU_d #(
    ...
    // ================= 顶层子模块实例化 =================
    // Stage1: A1 = Θ[10,7]+Θ[7,4]；   X1 = 2Δt * Θ[7,4]
    ...
    // Stage4: T3 = ?Δt?*Θ[9,9] + (Q+R)；  T4 = T1 + T2
    ...
    // 最终输出
    assign def       = stage4_T3 + stage4_T4; // 或者再用 fp_adder 做一次加法
